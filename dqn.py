...
class DqnAgent(object):
    ...
    def __init__(self, sess=None, learning_rate=0.00025, state_dims=[], num_actions=0,
        epsilon_start=0.1, epsilon_end=0.1, epsilon_decay_steps=50000):
        ...
        self._replay_buffer = ReplayBuffer(self.REPLAY_MEMORY_SIZE, self.BATCH_SIZE)
    ...
    def _q_network(self, state):
        ...
        layer1 = tf.contrib.layers.fully_connected(state, 20, activation_fn=tf.nn.relu)
